...
const Edit = () => {
    ...
    const validateForm = () => {
        ...
        if (!formData.acceptOffer) newErrors.acceptOffer = 'Accept Offer selection is required';
        if (formData.acceptOffer === 'No' && !formData.returnDate) newErrors.returnDate = 'Return Date is required if offer not accepted';
        if (formData.backOut === 'Yes' && !formData.reasonBackOut) newErrors.reasonBackOut = 'Reason for backing out is required';
        return newErrors;
    };
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.put(`${apiurl}/hrevalution/${formData.applicantId}`, formData, {
    ...
    return (
        <Container className="d-flex justify-content-center">
            <Col md lg={7} className="m-4">
                <h2 className="m-2">HR Interview Form Edit For {profile.applicant_id}</h2>
                ...
                <option key={location.id} value={location.name}>
                    ...
                    <Form.Group as={Row} className="mb-3">
                        ...
                        <Col sm={6}>
                            ...
                            />
                            <Form.Control.Feedback type="invalid">{errors.compensationType}</Form.Control.Feedback>
                        </Col>
                    </Form.Group>
                    ...
                    <Form.Group as={Row} className="mb-3">
                        ...
                        <Col sm={6}>
                            ...
                            />
                            <Form.Control.Feedback type="invalid">{errors.offeredSalary}</Form.Control.Feedback>
                        </Col>
                    </Form.Group>
