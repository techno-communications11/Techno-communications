...
function DirectNew() {
  ...
  const uniqueApplicants = sortedProfiles.filter(
    (applicant, index, self) =>
      index ===
      self.findIndex((a) => a.applicant_uuid === applicant.applicant_uuid)
  );
    ...
    <Container>
      ...
      {applicantDetails && (
        <Box mb={3}>
          ...
          <Typography>
            <span style={{ color: "blue" }}>Name:</span> {applicantDetails.name}
          </Typography>
          <Typography>
          ...
          <Typography>
            <span style={{ color: "blue" }}>Screening Manager:</span>{" "}
            {applicantDetails.screening_manager_name}
          </Typography>
